...
//            e.printStackTrace();
    ...
    public static void main(String[] args) {
        for (int i = 1;i <= 50;i++){
            ...
            String traninfo = (String)TxUtility.ClientToTransferVoteWithdraw(fromPubkey,WalletUtility.pubkeyStrToPubkeyHashStr(fromPubkey),BigDecimal.valueOf(300),nonce.longValue(),prikey,"0560af8314c3176c49679e727ca94c44b5e45852e6c3556e71a6124f7125cf3e").get("message");
            String txHash = (String)TxUtility.ClientToTransferVoteWithdraw(fromPubkey,WalletUtility.pubkeyStrToPubkeyHashStr(fromPubkey),BigDecimal.valueOf(300),nonce.longValue(),prikey,"0560af8314c3176c49679e727ca94c44b5e45852e6c3556e71a6124f7125cf3e").get("data");
