...
//            e.printStackTrace();
    ...
    public static void main(String[] args) {
        for (int i = 1;i <= 2;i++){
            ...
            String txInfo = (String) TxUtility.ClientToTransferAccount(fromPubkey,WalletUtility.pubkeyStrToPubkeyHashStr(fromPubkey), BigDecimal.valueOf(0.1),prikey, nonce.longValue()+i-1).get("message");
            String txHash = (String) TxUtility.ClientToTransferAccount(fromPubkey,WalletUtility.pubkeyStrToPubkeyHashStr(fromPubkey), BigDecimal.valueOf(0.1),prikey, nonce.longValue()+i-1).get("data");

            System.out.println("txInfo" + i + ":" + txInfo);
