...
//        sendTransaction(RawBasicTransaction);
        ...
        // 1.16 转账
//        String txInfo = (String) TxUtility.ClientToTransferAccount(fromPubkey,WalletUtility.pubkeyStrToPubkeyHashStr(fromPubkey), BigDecimal.valueOf(20),prikey, nonce.longValue()).get("message");
//        String txHash = (String) TxUtility.ClientToTransferAccount(fromPubkey,WalletUtility.pubkeyStrToPubkeyHashStr(fromPubkey), BigDecimal.valueOf(20),prikey, nonce.longValue()).get("data");
...
//        sendTransaction(txInfo);
        ...
        //1.19 投票
//        String traninfo = (String)TxUtility.ClientToTransferVote(fromPubkey,WalletUtility.pubkeyStrToPubkeyHashStr(fromPubkey),BigDecimal.valueOf(1800),nonce.longValue(),prikey).get("message");
//        String txHash = (String)TxUtility.ClientToTransferVote(fromPubkey,WalletUtility.pubkeyStrToPubkeyHashStr(fromPubkey),BigDecimal.valueOf(1800),nonce.longValue(),prikey).get("data");
//        System.out.println("traninfo:" + traninfo);
//        System.out.println("txHash:" + txHash);
//        sendTransaction(traninfo);
